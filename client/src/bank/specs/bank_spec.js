...
describe('bank', function(){
  ...
  it("should add iterest to bank accounts of type business",function(){
    var bank = new Bank();
    var account1 = new Account({owner:'Jay',amount:50, type:'business'});
    var account2 = new Account({owner:'Val',amount:150, type:'business'});
    var account3 = new Account({owner:'Kieth',amount:150, type:'personal'});
    ...
    assert.equal( 210, bank.totalCash('business') );
  });
  it("should add iterest to all bank accounts",function(){
    var bank = new Bank();
    var account1 = new Account({owner:'Jay',amount:50, type:'business'});
    var account2 = new Account({owner:'Val',amount:150, type:'business'});
    var account3 = new Account({owner:'Kieth',amount:150, type:'personal'});
    ...
    bank.addAccount(account3);
    bank.addInterest(5);
    assert.equal( 367.5, bank.totalCash());
  });
